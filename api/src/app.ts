...
import carbomateproductsRouter from './controllers/carbomateproducts.js';
import mappingakeneoRouter from './controllers/mappingakeneo.js';
import deleteZPRouter from './controllers/deleteZP.js';
...
export default async function createApp(): Promise<express.Application> {
	...
	app.use('/carbomateproducts', carbomateproductsRouter);
	app.use('/mappingakeneo', mappingakeneoRouter);
	app.use('/deleteZP', deleteZPRouter);
