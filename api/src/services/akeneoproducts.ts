...
export class AkeneoProductsService extends ItemsService {
	constructor(options: AbstractServiceOptions) {
		super('get_akeneo_products', options);
	}
	...
	// }
	override async updateOne(identifier: string, eshockId: string, zpId: string, opts?: MutationOptions): Promise<PrimaryKey> {
        // this.assertValidIpAccess(data);  

        // return super.updateOne(identifier, data, opts);
		// console.log("camevalu: ",identifier, "eshockId: ",eshockId, "zpId: ",zpId);
